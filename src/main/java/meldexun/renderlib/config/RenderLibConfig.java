...
public class RenderLibConfig {
    ...
    @Config.Comment("Tile entities whose bounding boxes won't be cached (Accepts 'tileentity'.")
    ...
    @Config.Comment("Allows you to increase the render bounding boxes of entities . Width increases the size on the X and Z axis. Top increases the size in the positive Y direction. Bottom increases the size in the negative Y direction. (Accepts entity=width,top,bottom'). Example Cow=10,10,10")
    ...
    public static String getEntityStringHelper(Class<? extends Entity> cls) {
		return EntityList.classToStringMapping.get(cls);
	}
