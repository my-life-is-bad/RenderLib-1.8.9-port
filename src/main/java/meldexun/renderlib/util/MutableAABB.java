...
public class MutableAABB {
	...
	public MutableAABB grow(Vec3 vec) {
		return grow(vec.xCoord, vec.yCoord, vec.zCoord);
	}
	...
	public MutableAABB expand(Vec3 vec) {
		return expand(vec.xCoord, vec.yCoord, vec.zCoord);
	}

	public MutableAABB expand(Vec3 vec, double d) {
		return expand(vec.xCoord, vec.yCoord, vec.zCoord, d);
	}
