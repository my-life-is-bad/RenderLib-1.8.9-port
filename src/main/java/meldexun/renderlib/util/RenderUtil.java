...
public class RenderUtil {
	...
	public static void updateCamera() {
		...
		Vec3 cameraOffset = ActiveRenderInfo.getPosition(); //getCameraPosition();
		...
		cameraOffsetX = cameraOffset.xCoord;
		cameraOffsetY = cameraOffset.yCoord;
		cameraOffsetZ = cameraOffset.zCoord;
